# RX / oneshot / oscillating valid
global ad_project_params

set ad_project_params(DATA_PATH_WIDTH) 16             ; ## 16 bytes

set ad_project_params(PATH_TYPE) 0                    ; ## RX
set ad_project_params(OFFLOAD_SIZE) 512               ; ## 1 KiB
...
set ad_project_params(SRC_OSCILLATING) 1              ; ## Whether the source valid signal should be toggled
                                                      ; ## repeatedly to simulate the cpack
...
set ad_project_params(SRC_TRANSFERS_LENGTH) 1048576   ; ## Transfer length
